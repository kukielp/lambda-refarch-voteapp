...
<testsuites name="jest tests" tests="44" failures="0" errors="0" time="4.432">
  <testsuite name="undefined" errors="0" failures="0" skipped="0" timestamp="2020-11-24T06:19:48" time="3.493" tests="43">
    ...
    <testcase classname=" constructs cannot be created with an empty name unless they are root" name=" constructs cannot be created with an empty name unless they are root" time="0.038">
    </testcase>
    ...
    <testcase classname=" cannot calculate uniqueId if the construct path is [&quot;Default&quot;]" name=" cannot calculate uniqueId if the construct path is [&quot;Default&quot;]" time="0.015">
    </testcase>
    ...
    <testcase classname=" addMetadata(type, data) can be used to attach metadata to constructs" name=" addMetadata(type, data) can be used to attach metadata to constructs" time="0.009">
    </testcase>
    ...
    <testcase classname=" construct.onValidate() can be implemented to perform validation, node.validate() will return all errors from the subtree (DFS)" name=" construct.onValidate() can be implemented to perform validation, node.validate() will return all errors from the subtree (DFS)" time="0">
    </testcase>
  ...
  <testsuite name="undefined" errors="0" failures="0" skipped="0" timestamp="2020-11-24T06:19:52" time="0.179" tests="1">
